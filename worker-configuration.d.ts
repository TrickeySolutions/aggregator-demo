/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 2422258e10ccb46fc240018a84e103eb)
// Runtime types generated with workerd@1.20250507.0 2025-05-02 
declare namespace Cloudflare {
	interface Env {
		CUSTOMERS: DurableObjectNamespace<import("./src/index").CustomerDO>;
		ACTIVITIES: DurableObjectNamespace<import("./src/index").ActivityDO>;
		PARTNERS: DurableObjectNamespace<import("./src/index").PartnerDO>;
		ACTIVITY_SUBMISSION_QUEUE: Queue;
		PARTNER_QUOTES_QUEUE: Queue;
		ASSETS: Fetcher;
		PARTNER_QUOTE_WORKFLOW: Workflow;
	}
}
